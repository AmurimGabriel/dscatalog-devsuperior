...
public class ProductResourceIT {
	...
	@Test
	public void findAllPageableShouldReturnSortedPageWhenSortedByName() throws Exception {
	...
	public void updateShouldReturnProductDTOWhenIdExists() throws Exception {
		...
		String expectedDescrption = productDTO.getDescription();
		...
		result.andExpect(jsonPath("$.description").value(expectedDescrption));
	}
